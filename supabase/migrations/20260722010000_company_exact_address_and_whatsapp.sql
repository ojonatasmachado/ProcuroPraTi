...
GRANT UPDATE (whatsapp, address_number) ON public.companies TO authenticated;
...
BEGIN
  ...
  ELSIF account_type = 'company' THEN
    INSERT INTO companies (
      id, name, email, phone, whatsapp, cnpj, address, address_number, postal_code, latitude, longitude, location_source,
    ...
    VALUES (
      ...
      nullif(new.raw_user_meta_data ->> 'address_number', ''), nullif(new.raw_user_meta_data ->> 'postal_code', ''),
