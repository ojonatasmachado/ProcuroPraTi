        ...
        {active === 'push' && (
          <Card className="border-border bg-card">
            ...
            <CardContent className="space-y-3">
              ...
              <EntryCard title="Suporte no iPhone"><p className="text-sm text-foreground/90"><Chip>getPushSupport()</Chip> (src/lib/pushNotifications.js) distingue dois motivos de "sem suporte" no iOS: app ainda não adicionado à Tela de Início (<Chip>ios-installation</Chip>) e iOS anterior ao 16.4, versão mínima da Apple para push em apps instalados (<Chip>ios-version</Chip>). O item "Ativar notificações" do menu do usuário (AppHeader.jsx) trata os dois casos como acionáveis em vez de simplesmente desabilitar: o primeiro abre o passo a passo de instalação (FirstProcuraInfoModal), o segundo mostra um toast explicando como atualizar o iOS.</p></EntryCard>
              <EntryCard title="Convite para instalar (InstallOnboarding)"><p className="text-sm text-foreground/90"><Chip>InstallOnboarding.jsx</Chip> só abre depois da primeira procura criada (lado comprador) ou da primeira resposta enviada (lado empresa/CDV), nunca durante o tour de onboarding nem simultâneo ao <Chip>FirstProcuraInfoModal</Chip> (props <Chip>milestoneReached</Chip> e <Chip>blocked</Chip> em App.jsx). Não aparece se o app já estiver instalado (<Chip>isStandalonePwa()</Chip>).</p></EntryCard>
            </CardContent>
          </Card>
        )}
