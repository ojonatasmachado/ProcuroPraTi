        ...
        {active === 'limitations' && (
          <Card className="border-warning/40 bg-warning/5">
            ...
            <CardContent className="space-y-3">
              ...
              <EntryCard title="Função handle_new_auth_user sem uso"><p className="text-sm text-foreground/90">Existe no banco com a mesma lógica de handle_new_account, mas não está associada a nenhum trigger hoje. É código morto, seguro de remover numa limpeza futura.</p></EntryCard>
